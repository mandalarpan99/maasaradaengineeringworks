...
export const translations = {
  ...
  bn: {
    ...
    stats: {
      items: [
        { value: '15+',    label: 'বছরের অভিজ্ঞতা',     icon: '🏆' },
        { value: '1,200+', label: 'প্রকল্প সম্পন্ন',    icon: '📐' },
        { value: '500+',   label: 'সন্তুষ্ট গ্রাহক',    icon: '🤝' },
        { value: '100%',   label: 'সাইট নিরাপত্তা রেকর্ড', icon: '🛡️' },
      ],
    },
    ...
    footer: {
      ...
      tagline:     'নির্ভুল ধাতব তৈরি, গেট, ছাদ শেড ও জানালা। টেকসইভাবে তৈরি — ২০১১ থেকে।',
